...
export const seedAssets = [
  ...
  { id: "seed-asset-5", name: "Brand Direction", type: "Design", icon: "image", agent: "designer", section: "style", time: "3d ago", content: { palette: { primary: "#258530", secondary: "#181C23", accent: "#e6f2e8", rationale: "Signals depth, confidence, and precision." }, typography: { heading: "Inter", body: "Inter", rationale: "Operational clarity without noise." }, ui_direction: "Command center meets premium creator OS." } },
];

export const seedEvents = [
  { id: "seed-event-1", day: 0, slot: 2, title: "Tiny Fish Accelerator review", bg: "#181C23", color: "#fff" },
